<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="docs-page.aspx.cs" Inherits="projectsmember.members.docs_page" %>
        ...
        <div class="branding docs-branding">
            <div class="container-fluid position-relative py-2">
                <div class="docs-logo-wrapper">
	                ...
	                <div class="site-logo"><a class="navbar-brand" href="members.aspx"><img class="logo-icon me-2" src="members/assets/images/coderdocs-logo.svg" alt="logo"><span class="logo-text">Coder<span class="text-alt">Docs</span></span></a></div>    
					...
					<section class="docs-section" id="item-1-2">
						...
						<div class="simplelightbox-gallery row mb-3">
							<div class="col-12 col-md-4 mb-3">
						        <a href="members/assets/images/coderpro-home.png"><img class="figure-img img-fluid shadow rounded" src="members/assets/images/coderpro-home-thumb.png" alt="" title="CoderPro Home Page"/></a>
							</div>
							<div class="col-12 col-md-4 mb-3">
						        <a href="members/assets/images/coderpro-features.png"><img class="figure-img img-fluid shadow rounded" src="members/assets/images/coderpro-features-thumb.png" alt="" title="CoderPro Features Page"/></a>
							</div><!--//col-->
							<div class="col-12 col-md-4 mb-3">
						        <a href="members/assets/images/coderpro-pricing.png"><img class="figure-img img-fluid shadow rounded" src="members/assets/images/coderpro-pricing-thumb.png" alt="" title="CoderPro Pricing Page"/></a>
							</div><!--//col-->
