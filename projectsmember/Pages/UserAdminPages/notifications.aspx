<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="notifications.aspx.cs" Inherits="projectsmember.notifications" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
     <link rel="icon" type="image/png" href="../../Content/Image/img/Notiffavicon.png">
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <%--<li class="nav-item">
          ...
          <li class="nav-item">
          <a class="nav-link text-white " href="Profile.aspx">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
       ...
       <%-- <li class="nav-item">
        ...
        <li class="nav-item">
          <a class="nav-link text-white active bg-gradient-primary " href="notifications.aspx">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
