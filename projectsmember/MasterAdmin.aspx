<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MasterAdmin.aspx.cs" Inherits="projectsmember.MasterAdmin" %>
       ...
       <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
            ...
            <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white active bg-gradient-secondary"  href="notifications.aspx">
                            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
                         ...
                         <div class="card my-4">
                             <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="bg-gradient-dark shadow-dark border-radius-lg pt-4 pb-3">
                                    <h6 class="text-white text-capitalize ps-3">co-worker Table</h6>
                                </div>
                            </div>
                             <div class="card-body p-0">
                                <div class=" table">
                                    <asp:GridView ID="GViewMasterAdmin"   class="table table-responsive  table-condensed table-hover" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" AllowPaging="True" AllowSorting="True" DataSourceID="SqlDataSource1">
                                        <Columns>
                                    ...
                                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConflictDetection="CompareAllValues" ConnectionString="<%$ ConnectionStrings:db_a12df8_sojairishConnectionString %>" DeleteCommand="DELETE FROM [Admin] WHERE [Id] = @original_Id AND [Username] = @original_Username AND [Password] = @original_Password AND (([Name] = @original_Name) OR ([Name] IS NULL AND @original_Name IS NULL)) AND (([Type] = @original_Type) OR ([Type] IS NULL AND @original_Type IS NULL)) AND (([LastLogin] = @original_LastLogin) OR ([LastLogin] IS NULL AND @original_LastLogin IS NULL)) AND (([Status] = @original_Status) OR ([Status] IS NULL AND @original_Status IS NULL)) AND (([ExtraData] = @original_ExtraData) OR ([ExtraData] IS NULL AND @original_ExtraData IS NULL))" InsertCommand="INSERT INTO [Admin] ([Username], [Password], [Name], [Type], [LastLogin], [Status], [ExtraData]) VALUES (@Username, @Password, @Name, @Type, @LastLogin, @Status, @ExtraData)" OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT * FROM [Admin]" UpdateCommand="UPDATE [Admin] SET [Username] = @Username, [Password] = @Password, [Name] = @Name, [Type] = @Type, [LastLogin] = @LastLogin, [Status] = @Status, [ExtraData] = @ExtraData WHERE [Id] = @original_Id AND [Username] = @original_Username AND [Password] = @original_Password AND (([Name] = @original_Name) OR ([Name] IS NULL AND @original_Name IS NULL)) AND (([Type] = @original_Type) OR ([Type] IS NULL AND @original_Type IS NULL)) AND (([LastLogin] = @original_LastLogin) OR ([LastLogin] IS NULL AND @original_LastLogin IS NULL)) AND (([Status] = @original_Status) OR ([Status] IS NULL AND @original_Status IS NULL)) AND (([ExtraData] = @original_ExtraData) OR ([ExtraData] IS NULL AND @original_ExtraData IS NULL))">
                                        <DeleteParameters>
                                            ...
                                            <asp:Parameter Name="original_LastLogin" Type="DateTime" />
                                            <asp:Parameter Name="original_Status" Type="Int32" />
                                            <asp:Parameter Name="original_ExtraData" Type="String" />
                                        </DeleteParameters>
                                        <InsertParameters>
                                            ...
                                            <asp:Parameter Name="ExtraData" Type="String" />
                                        </InsertParameters>
                                        <UpdateParameters>
                                            <asp:Parameter Name="Username" Type="String" />
                                            <asp:Parameter Name="Password" Type="String" />
        ...
        <div class="card-body p-0">
          <table class="table table-striped table-responsive table-bordered projects">
              <thead>
                  <tr>
                      <th style="width: 1%">
                          #
